...
public class BookControllerTest {
    ...
    public void testGetAllBooks() throws Exception {
        ...
        mockMvc.perform(get("/books")
                ...
                .andExpect(content().json("[{'id':1,'title':'Book Title 1','author':'Author 1','price':9.99,'isbn':'ISBN123'},{'id':2,'title':'Book Title 2','author':'Author 2','price':19.99,'isbn':'ISBN456'}]"));
    }
}
